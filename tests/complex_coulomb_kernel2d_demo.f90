PROGRAM demo
  ...
  CALL save_array2d("outputs/output_complex_coulomb_2d_real.txt", dble(potential))
  CALL save_array2d("outputs/output_complex_coulomb_2d_imag.txt", imag(potential))
